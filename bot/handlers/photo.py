...
PHOTO_MODEL_CODES = ["nano_banana", "gpt_image_2", "seedream", "grok_image", "z_image"]
...
async def photo_models(message: Message) -> None:
    ...
    try:
        ...
        await message.answer("🖼 Выберите модель генерации изображений:", reply_markup=webapp_models_keyboard(items))
    except Exception:
