AI_MODELS_CATALOG = [
    ...
    },
    {
        ...
        "form_schema": {
            ...
            "fields": [
                {"name": "prompt", "provider_key": "prompt", "label": "Промт", "type": "textarea", "required": True, "placeholder": "Опишите, что нужно сгенерировать"},
                {"name": "image_url", "provider_key": "image_url", "label": "Исходное фото", "type": "file", "required": False, "accept": "image/*", "max_size_mb": 30, "helper_text": "Опционально: фото для image-to-image редактирования"},
                {"name": "aspect_ratio", "provider_key": "aspect_ratio", "label": "Соотношение сторон", "type": "select", "default": "1:1", "options": ["auto", "21:9", "16:9", "3:2", "4:3", "5:4", "1:1", "4:5", "3:4", "2:3", "9:16"]},
...
set_model(
    ...
    sort_order=23,
    default_params={"num_images": 1, "quality": "high", "output_format": "png", "sync_mode": False},
    description="Редактирует загруженные изображения по промпту.",
    form_schema=schema(
        [
...
SEEDANCE_DURATION_PRICE = {"auto": 1, "4": 0.8, "5": 1, "6": 1.2, "7": 1.4, "8": 1.6, "9": 1.8, "10": 2, "11": 2.2, "12": 2.4, "13": 2.6, "14": 2.8, "15": 3}
SEEDANCE_REFERENCE_DURATION_PRICE = {"auto": 1, "4": 0.8, "5": 1, "6": 1.2, "7": 1.4, "8": 1.6, "9": 1.8, "10": 2, "11": 2.2, "12": 2.4, "13": 2.6, "14": 2.8, "15": 3}
GROK_DURATION = [4, 6]

set_model(
    "seedance_2_t2v",
    title="Seedance 2.0 · по тексту",
    category="video",
    provider="fal",
    ...
    description="Создаёт видео по текстовому описанию.",
    form_schema=schema(
        [
...
set_model(
    "seedance_2_t2v_fast",
    title="Seedance 2.0 · быстро по тексту",
    category="video",
    provider="fal",
    ...
    sort_order=15,
    default_params={"resolution": "720p", "duration": "5", "aspect_ratio": "16:9", "generate_audio": True, "sync_mode": False},
    description="Быстро создаёт видео по текстовому описанию.",
    form_schema=schema(
        [
            field("prompt", "Промт", "textarea", required=True, placeholder="Опишите видео"),
            field("aspect_ratio", "Соотношение сторон", "select", default="16:9", options=VIDEO_ASPECT, advanced=False),
...
set_model(
    "seedance_2_i2v_fast",
    title="Seedance 2.0 · быстро по фото",
    category="video",
    provider="fal",
    ...
    description="Быстро оживляет фотографию.",
    form_schema=schema(
        [
...
set_model(
    "seedance_2_mini_t2v",
    title="Seedance 2.0 · доступно по тексту",
    category="video",
    provider="fal",
    ...
    sort_order=16,
    default_params={"resolution": "720p", "duration": "5", "aspect_ratio": "16:9", "generate_audio": True, "sync_mode": False},
    description="Доступное видео по текстовому описанию.",
    form_schema=schema(
        [
            field("prompt", "Промт", "textarea", required=True, placeholder="Опишите видео"),
            field("aspect_ratio", "Соотношение сторон", "select", default="16:9", options=VIDEO_ASPECT, advanced=False),
...
set_model(
    "seedance_2_mini_i2v",
    title="Seedance 2.0 · доступно по фото",
    category="video",
    provider="fal",
    ...
    sort_order=26,
    default_params={"resolution": "720p", "duration": "5", "aspect_ratio": "auto", "generate_audio": True, "sync_mode": False},
    description="Доступно оживляет фотографию.",
    form_schema=schema(
        [
            field("image_url", "Стартовое изображение", "file", required=True, accept="image/*", max_size_mb=30, helper_text="JPEG/PNG/WebP до 30MB"),
            field("prompt", "Промт", "textarea", required=True, placeholder="Опишите движение и сцену"),
...
set_model(
    ...
    title="Seedance 2.0 · доступно по референсам",
    category="video",
    provider="fal",
    ...
    description="Доступное видео по нескольким референсам.",
    form_schema=schema(
        [
...
set_model(
    ...
    title="Seedance 2.0 · по референсам",
    category="video",
    provider="fal",
    ...
    sort_order=24,
    default_params={"resolution": "480p", "duration": "5", "aspect_ratio": "9:16", "generate_audio": True, "sync_mode": False},
    description="Создаёт видео по нескольким референсам.",
    form_schema=schema(
        [
            field("image_urls", "Фото-референсы", "files", required=True, accept="image/*", min_files=1, max_files=9, maps_to="image_urls", helper_text="Загрузите 1–9 изображений-референсов"),
            field("prompt", "Промт", "textarea", required=True, placeholder="Опишите видео и используйте @Image1, @Image2..."),
...
set_model(
    ...
    title="Seedance 2.0 · быстро по референсам",
    category="video",
    provider="fal",
    ...
    sort_order=25,
    default_params={"resolution": "480p", "duration": "5", "aspect_ratio": "9:16", "generate_audio": True, "sync_mode": False},
    description="Быстро создаёт видео по нескольким референсам.",
    form_schema=schema(
        [
            field("image_urls", "Фото-референсы", "files", required=True, accept="image/*", min_files=1, max_files=9, maps_to="image_urls", helper_text="Загрузите 1–9 изображений-референсов"),
            field("prompt", "Промт", "textarea", required=True, placeholder="Опишите видео и используйте @Image1, @Image2..."),
...
set_model(
    ...
    sort_order=30,
    default_params={"resolution": "720p", "duration": "5", "aspect_ratio": "auto", "generate_audio": True, "sync_mode": False},
    description="Качественно оживляет фотографию с поддержкой 1080p.",
    form_schema=schema(
        [
            field("image_url", "Стартовое изображение", "file", required=True, accept="image/*", max_size_mb=30, helper_text="JPEG/PNG/WebP до 30MB"),
            field("prompt", "Промт", "textarea", required=True, placeholder="Опишите движение и сцену"),
...
set_model(
    ...
    description="Оживляет загруженную фотографию.",
    form_schema=schema(
        [
            field("image_url", "Стартовое изображение", "file", required=True, accept="image/*", max_size_mb=30, helper_text="JPEG/PNG/WebP до 30MB"),
...
set_model(
    ...
    description="Качественно оживляет загруженную фотографию.",
    form_schema=schema(
        [
...
set_model(
    ...
    title="Kling 3.0 · перенос движения",
    category="video",
    provider="fal",
    ...
    description="Переносит движение из видео-референса на персонажа.",
    form_schema=schema(
        [
...
set_model(
    ...
    description="Создаёт кинематографичное видео по текстовому описанию.",
    form_schema=schema(
        [
            field("prompt", "Промт", "textarea", required=True, placeholder="Опишите видео"),
            ...
            field("auto_fix", "Автоисправление промпта", "switch", default=True, advanced=True),
            field("safety_tolerance", "Уровень безопасности", "select", default="4", options=SAFETY_TOLERANCE, advanced=True),
            field("negative_prompt", "Что исключить", "textarea", required=False, advanced=True),
...
set_model(
    ...
    description="Кинематографично оживляет загруженную фотографию.",
    form_schema=schema(
        [
...
set_model(
    ...
    description="Оживляет загруженное изображение.",
    form_schema=schema(
        [
            field("image_url", "Стартовое изображение", "file", required=True, accept="image/*", max_size_mb=30, helper_text="JPEG/PNG/WebP до 30MB"),
            field("prompt", "Промт", "textarea", required=True, placeholder="Опишите движение и сцену"),
...
set_model(
    ...
    description="Оживляет фото со звуком и синхронизацией речи.",
    form_schema=schema(
        [
            field("image_url", "Стартовое изображение", "file", required=True, accept="image/*", max_size_mb=30, helper_text="JPEG/PNG/WebP до 30MB"),
            field("prompt", "Промт", "textarea", required=True, placeholder="Опишите движение и сцену"),
