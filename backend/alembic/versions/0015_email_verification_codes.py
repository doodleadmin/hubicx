...
Revision ID: 0015_email_verification_codes
Revises: 0014_user_bans
...
revision = "0015_email_verification_codes"
down_revision = "0014_user_bans"
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_index(op.f("ix_email_verification_codes_purpose"), "email_verification_codes", ["purpose"])
