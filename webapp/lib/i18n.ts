...
const dictionaries: Record<Locale, Record<string, string>> = {
  ru: {
    ...
    "nav.home": "Главная", "nav.create": "Создать", "nav.agents": "Агенты", "nav.history": "История", "nav.balance": "Баланс",
    "create.title": "Что создаём?", "create.subtitle": "Выберите сценарий, а форма откроется с реальными параметрами модели.", "create.image": "Изображения", "create.imageDesc": "Генерация и редактирование фото", "create.video": "Видео", "create.videoDesc": "Видео из текста или изображения", "create.text": "Текст", "create.textDesc": "Чат и текстовые инструменты", "create.prompts": "Промты", "create.promptsDesc": "Помощник для точных промтов",
    "agents.title": "AI-агенты", "agents.subtitle": "Готовые роли для задач. Основные генераторы уже работают, агенты подключаются постепенно.", "agents.soon": "Скоро", "templates.title": "Шаблоны", "templates.subtitle": "Готовые сценарии с реальными WebApp-формами.",
  ...
  en: {
    ...
    "nav.home": "Home", "nav.create": "Create", "nav.agents": "Agents", "nav.history": "History", "nav.balance": "Balance",
    "create.title": "What to create?", "create.subtitle": "Choose a scenario; the form opens with real model parameters.", "create.image": "Images", "create.imageDesc": "Image generation and editing", "create.video": "Video", "create.videoDesc": "Video from text or image", "create.text": "Text", "create.textDesc": "Chat and text tools", "create.prompts": "Prompts", "create.promptsDesc": "Helper for precise prompts",
    "agents.title": "AI agents", "agents.subtitle": "Ready roles for tasks. Core generators already work; agents are added gradually.", "agents.soon": "Soon", "templates.title": "Templates", "templates.subtitle": "Ready scenarios with real WebApp forms.",
...
dictionaries.es = { ...dictionaries.en,
  ...
  "nav.home": "Inicio", "nav.create": "Crear", "nav.agents": "Agentes", "nav.history": "Historial", "nav.balance": "Saldo",
  "create.title": "¿Qué creamos?", "create.subtitle": "Elige un escenario; el formulario usa parámetros reales.", "create.image": "Imágenes", "create.imageDesc": "Generación y edición de imágenes", "create.video": "Video", "create.videoDesc": "Video desde texto o imagen", "create.text": "Texto", "create.textDesc": "Chat y herramientas de texto", "create.prompts": "Prompts", "create.promptsDesc": "Ayuda para prompts precisos",
  "agents.title": "Agentes IA", "agents.subtitle": "Roles listos para tareas. Los generadores principales ya funcionan; los agentes se conectan gradualmente.", "agents.soon": "Próximamente", "templates.title": "Plantillas", "templates.subtitle": "Escenarios listos con formularios reales.",
...
dictionaries.pt = { ...dictionaries.en,
  ...
  "nav.home": "Início", "nav.create": "Criar", "nav.agents": "Agentes", "nav.history": "Histórico", "nav.balance": "Saldo",
  "create.title": "O que vamos criar?", "create.subtitle": "Escolha um cenário; o formulário usa parâmetros reais.", "create.image": "Imagens", "create.imageDesc": "Geração e edição de imagens", "create.video": "Vídeo", "create.videoDesc": "Vídeo a partir de texto ou imagem", "create.text": "Texto", "create.textDesc": "Chat e ferramentas de texto", "create.prompts": "Prompts", "create.promptsDesc": "Ajuda para prompts precisos",
  "agents.title": "Agentes IA", "agents.subtitle": "Papéis prontos para tarefas. Os geradores principais já funcionam; agentes serão conectados gradualmente.", "agents.soon": "Em breve", "templates.title": "Modelos", "templates.subtitle": "Cenários prontos com formulários reais.",
